...
namespace Executores
{
    public class VALIDATION
    {
        ...
        public static readonly MessageValidation REQUIS_ADRESSE_EMAIL = new MessageValidation("012", "L'adresse e-mail est requise");
        public static readonly MessageValidation LONGUEUR_ADRESSE_EMAIL = new MessageValidation("013", "L'adresse e-mail doit faire moins de " + CHAINE_LONGUEUR_MAX + " caractères");
        public static readonly MessageValidation INVALIDE_ADRESSE_EMAIL = new MessageValidation("014", "L'adresse e-mail est invalide");
        public static readonly MessageValidation REQUIS_NOM = new MessageValidation("015", "Le nom est requis");
        public static readonly MessageValidation LONGUEUR_NOM = new MessageValidation("016", "Le nom doit faire moins de " + CHAINE_LONGUEUR_MAX + " caractères");
        public static readonly MessageValidation REQUIS_PRENOM = new MessageValidation("017", "Le prénom est requis");
        public static readonly MessageValidation LONGUEUR_PRENOM = new MessageValidation("018", "Le prénom doit faire moins de " + CHAINE_LONGUEUR_MAX + " caractères");
        public static readonly MessageValidation REQUIS_NUMERO_TELEPHONE = new MessageValidation("019", "Le numéro de téléphone est requis");
        public static readonly MessageValidation INVALIDE_NUMERO_TELEPHONE = new MessageValidation("020", "Le numéro de téléphone est invalide");
